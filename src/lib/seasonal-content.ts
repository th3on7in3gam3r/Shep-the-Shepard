...
const ADVENT_SHEP_COMPLETE: readonly string[] = [
  "Baa… one more step toward Bethlehem. Well done, little lamb.",
  ...
  "Hope looks good on you. See you tomorrow, little lamb.",
];

const LENT_SHEP_COMPLETE: readonly string[] = [
  "Baa… you walked faithfully today. The Good Shepherd sees you.",
...
export function getSeasonalShepLine(
  ...
  if (context === "quest-complete") {
    ...
    if (info.dayInSeason >= 7) {
      return "Baa! Christ is risen — what a day to finish your quest!";
    }
    return "Baa… you walked through Holy Week with faith. I'm proud of you.";
  }
